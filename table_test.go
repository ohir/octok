...
var tokTestTable = []ptestItem{ // desc, Fl, Tt, Np, pResult / from / mock
	...
	{`disambiguation after rem`, NoneF, 0x00, 0x0023, LintOK, ParseOK,
		...
		"N     n : V           v P ^"},
	{`disambiguation after rem with tabs`, NoneF, 0x00, 0x0023, LintOK, ParseOK,
		"Na!//me!:! !+.!//!rem:.!'.$", // check tabs support too
		"N     n : V           v P ^"},
	...
	{`skip empty rem right after empty value`, IsEmpty, 0x00, 0x0000, LintOK, ParseOK,
		"$  $  $  n : //[mmme]  $",
		"         n : ^          "},
	{`del in line`, NoneF, 0x00, 0x0000, LintCtlChars, ParseNone,
		" n&n : v$ n : v$",
		"          n : v^"},
	{`tab in line`, NoneF, 0x00, 0x0000, LintOK, Parsed2,
		" n!n : v$ n : v$",
		"          n : v^"},
	{`zero in line`, NoneF, 0x00, 0x0000, LintCtlChars, ParseNone,
		" n\000n : v$ n : v$",
		"          n : v^"},
	{`ctl leads name`, NoneF, 0x00, 0x0000, LintCtlChars, ParseNone,
		"\vName : Value$Name : Value$",
		"              N  n : V   v^"},
	{`ctl in name`, NoneF, 0x00, 0x0000, LintCtlChars, ParseNone,
		"Na\vme : Value$Name : Value$",
		"              N  n : V   v^"},
	{`ctl in value`, NoneF, 0x00, 0x0000, LintCtlChars, ParseNone,
		"Name : Va\vlue$Name : Value$",
		"              N  n : V   v^"},
	{`apo single tabbed sep`, IsOrd | IsEmpty, 0x00, 0x0000, LintOK, ParseOK,
		" '!:!$",
		" ' :^ "},
	...
	{`raw value tab`, IsOrd, 0x00, 0x0000, LintOK, ParseOK,
		...
		":             ^  V                    v                            "},
	{`raw value Vtab is bad too`, IsOrd, 0x00, 0x0000, LintCtlChars, ParseNone,
